 ...
 * @author minon
 */
@Entity(name = "BankUsers")
@DiscriminatorValue(value = "B")
public class BankUser extends SystemUser {

    public BankUser(int userID, String lastName, String firstName, EmailAddress emailAddress, Address address, PhoneNumber phoneNumber) {
